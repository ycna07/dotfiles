...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting zsh-completions zsh-fzf-history-search sudo zoxide eza starship)
source $ZSH/oh-my-zsh.sh

# User configuration
# 设置历史文件路径（默认通常是 ~/.zsh_history）
HISTFILE=~/.config/zsh/.zsh_history  # 这里可以替换为你想要的路径，如 ~/Documents/zsh_history
